...
import { logIn } from "../../authResponse/authResponse";
...
const LogIn = () => {
  ...
  const handleFocus = (type) => {
    type === 'email' ? emailRef.current.classList.add('label') : passRef.current.classList.add('label')
  ...
  const handleShowPass = () => {
    ...
    value ? passInputRef.current.setAttribute(
      'type',
      'text'
    )
      :
      passInputRef.current.setAttribute(
        'type',
        'password'
      )
  }
  ...
  const handleLogin =(e)=>{
    e.preventDefault()
    logIn(emailInput,passInput,navigation,dispatchLogin)
        ...
        <div className="form-value">
          <form action="">
            ...
            <div className="inputbox" >
              ...
              <input type="password" value={passInput} required ref={passInputRef} onChange={(e) => handleInput(e.target)} onFocus={() => handleFocus()} onBlur={() => handleBlur('password')} />
            ...
            <div className="register">
              <p>
                Don't have a account <a href="#" onClick={() => navigation("/auth/signup")}>Register</a>
              </p>
            </div>
          </form>
        </div>
